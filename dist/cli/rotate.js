...
import { printPairingQr } from "./pairing.js";
import { addZshrcBlock } from "./settings-surgeon.js";
/**
 ...
 */
export async function rotate(deps) {
    ...
    if (!rotated.ok) {
        io.say(rotated.error === 'unauthorized'
    ...
    await files.write(paths.configFile, JSON.stringify({ gatewayUrl, interceptQuestions, deckKey: rotated.value.deckKey }, null, 2) + '\n');
