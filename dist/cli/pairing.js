...
export function pairingUrl(baseUrl, deckKey) {
...
export const PAIRING_URL_CAVEAT = 'or open this link (contains your deck key — treat it like a password):';
/**
 ...
 */
export function sayPairing(io, renderQr, url) {
    io.say(renderQr(url));
...
export function phoneReachableBase(deps, gatewayUrl) {
 ...
 */
export function printPairingQr(deps, config) {
