 ...
 */
export function equals(storedHash, key) {
 ...
 */
export function encodeInstall(gatewayUrl, key) {
 ...
 */
export function decodeInstall(blob) {
    let parsed;
    try {
 ...
 */
export function pairingUrl(gatewayUrl, key) {
